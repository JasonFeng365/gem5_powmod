...
./build/X86/gem5.opt -re --debug-flags=PowmodAccel,Exec --debug-file=debug.txt --outdir m5out/benchmark configs/deprecated/example/se.py --cpu-type=O3CPU --caches --cmd=./benchmark < input.txt
